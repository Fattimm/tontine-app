...
<head>
    ...
    <title>Erreur serveur — TontineApp</title>
...
<div class="auth-card card shadow-sm w-100 mx-3 text-center">
    <div class="card-body p-5">
        <div class="display-1 text-danger mb-2"><i class="bi bi-exclamation-circle"></i></div>
        <div class="display-1 fw-bold text-danger mb-2">500</div>
        <h4 class="fw-bold mb-2">Erreur serveur</h4>
        <p class="text-muted mb-4">Une erreur inattendue s'est produite. Veuillez réessayer dans quelques instants.</p>
        @auth
